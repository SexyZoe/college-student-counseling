...
Page({
  data: { classId: "", className: "", students: [], filtered: [], filters: ["全部", "未完成", "关注", "较高风险"], activeFilter: "全部", summary: {}, riskDistribution: [], dimensions: [] },
  ...
  loadData() {
    ...
    this.setData({
      ...
      riskDistribution: [{ label:"正常", value:count("正常"), color:"#8fc8b5" }, { label:"关注", value:count("关注"), color:"#f5d79e" }, { label:"较高风险", value:count("较高风险"), color:"#f4a3a8" }, { label:"未评估", value:count("未评估"), color:"#c8c8c8" }],
