...
当前版本已迁移为浏览器应用。以 [校园Web上线手册](../docs/校园Web上线手册.md) 为准；微信版本可从 GitHub 标签 `wechat-final-2026-09-24` 恢复。

下面保留原实例的操作记录，帮助识别现有部署、备份和定时任务；其中微信调试和原上线边界是迁移前历史信息，不代表当前发布步骤。
