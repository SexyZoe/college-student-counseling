...
function loadConfig(environment) {
  ...
  return {
    ...
    maxMediaBytes: integerSetting(env, "MAX_MEDIA_BYTES", 100 * 1024 * 1024, 1024, 200 * 1024 * 1024),
    mediaUploadTimeoutMs: integerSetting(env, "MEDIA_UPLOAD_TIMEOUT_MS", 300000, 10000, 900000),
    uploadDirectory: env.UPLOAD_DIRECTORY || path.join(__dirname, "..", "data", "uploads"),
    webRoot: env.WEB_ROOT || path.join(__dirname, "..", "web"),
